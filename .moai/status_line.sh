...
if [ -f "/Users/sage/go/bin/moai" ]; then
	exec "/Users/sage/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/sage/.local/bin/moai" ]; then
	exec "/Users/sage/.local/bin/moai" statusline < "$temp_file"
fi
