...
export function useFetch<T>(
  ...
  const { immediate = true, refetch = false, initialData = null, onSuccess, onError } = options;
...
watch([count, () => state.loading], ([newCount, newLoading], [oldCount, oldLoading]) => {
...
<template>
  <div :class="{ dark: theme === 'dark' }">
    <header>
      <button @click="toggleTheme">{{ theme === 'dark' ? 'Light' : 'Dark' }} Mode</button>
